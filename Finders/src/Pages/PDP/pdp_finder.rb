...
module DriverModules
  module PDP
    ...
    def bops_select_callstore_button
      #FindersDef.new(self).find_element("xpath","//android.widget.TextView[contains(@text,'SELECT STORE')]",__method__)
    ...
    def readyForPickUpTxtNotification
      FindersDef.new(self).find_element("id","com.gamestop.powerup.gti:id/text_bops_header_info",__method__)

    end

    def shipGroupHeader
      FindersDef.new(self).find_element("id","com.gamestop.powerup.gti:id/ship_group_header",__method__)

    end

    def cart_availability_variants
      FindersDef.new(self).find_element("id","com.gamestop.powerup.gti:id/cart_availability_textview",__method__)
    ...
    def itemSearchCategory

      #FindersDef.new(self).find_element("xpath","//android.widget.TextView[@text='Unable to search.']",__method__)
      FindersDef.new(self).find_element("id","com.gamestop.powerup.gti:id/search_category_textview",__method__)
    end
