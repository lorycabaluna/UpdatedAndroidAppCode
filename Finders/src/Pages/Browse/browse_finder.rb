...
module BrowseFinder
  ...
  def filter_category_textItem(category)
    FindersDef.new(self).find_element("xpath","//android.widget.TextView[@text='#{category}']",__method__)
  end

  def filter_category_checkBoxItem(category)
    FindersDef.new(self).find_element("xpath","//android.widget.CheckBox[@text='#{category}']",__method__)
  end

  def filter_category_radioButtonItem(category)
    FindersDef.new(self).find_element("xpath","//android.widget.RadioButton[@text='#{category}']",__method__)
  end
