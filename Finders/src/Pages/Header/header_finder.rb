module DriverModules
  module Header
    ...
    def cart_shipToMe
      FindersDef.new(self).find_element("id","com.gamestop.powerup.gti:id/cart_shiptome_textview",__method__)

    end

    def cart_pickUPAtStore
      FindersDef.new(self).find_element("id","com.gamestop.powerup.gti:id/cart_pickupatstore_textview",__method__)
