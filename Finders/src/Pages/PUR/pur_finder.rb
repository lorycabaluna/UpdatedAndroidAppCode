module DriverModules
  module PUR
    ...
    def pur_userType
      ...
      FindersDef.new(self).find_element("id","com.gamestop.powerup.gti:id/rewards_purmain_usertypetextview",__method__)
    end
    ...
    def pur_cardDetails_tradeCreditEasyAccessPIN
      FindersDef.new(self).find_element("xpath","(//android.widget.TextView[@content-desc='NO_RESOURCE_NAME'])[1]",__method__)
    end

    def pur_cardDetails_tradeCreditBalanceHeader
      FindersDef.new(self).find_element("id","com.gamestop.powerup.gti:id/credit_header_textview",__method__)
    end

    def pur_cardDetails_tradeCreditBalanceValue
      FindersDef.new(self).find_element("id","com.gamestop.powerup.gti:id/credit_value_textview",__method__)
    end
    ...
    def pur_rewardsCenter_firstListItem
      FindersDef.new(self).find_element("xpath","(//android.widget.ImageView[@content-desc='GameStop'])[1]",__method__)
    end

    def pur_rewardsCenter_getItNow
      FindersDef.new(self).find_element("id","com.gamestop.powerup.gti:id/reward_placeordertextview",__method__)
    end

    def pur_rewardsCenter_placeYourOrder
      FindersDef.new(self).find_element("id","com.gamestop.powerup.gti:id/rewardsummary_submit_toptextview",__method__)
    end

    def pur_confirmationNumber
      FindersDef.new(self).find_element("id","com.gamestop.powerup.gti:id/rewardconfirmation_confirmationnumber_textview",__method__)
    end

    def pur_continueShopping
      FindersDef.new(self).find_element("id","com.gamestop.powerup.gti:id/rewardconfirmation_submit_textview",__method__)
    end
